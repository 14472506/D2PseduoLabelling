...
BURN_IN_WEIGHTS="outputs/m2f/burn_in_025/01_continued_01/burn_in_best_model.pth"

TRAIN_DATASET="('jersey_train',)"
VAL_DATASET="('jersey_val',)"

TEST_WEIGHTS=(
    "outputs/m2f/dist_035/01_continued_03/distillation_best_model.pth"

)
TEST_DATASET="('jersey_test',)"

OUTPUT_DIRS=(
    "outputs/m2f/dist_035/01_continued_03"
)
