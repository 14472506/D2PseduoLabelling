...
TRAIN_WEIGHTS=(
    "outputs/ps_dev/added_weighting_035/burn_in_best_model.pth"
...
TEST_WEIGHTS=(
    "outputs/mrcnn_ps_exps/vol_sym/025_1/distillation_best_model.pth"
...
OUTPUT_DIRS=(
    "outputs/ps_dev/added_weighting_9998_035_3"
