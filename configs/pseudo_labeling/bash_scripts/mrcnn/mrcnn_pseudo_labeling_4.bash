...
TEST_WEIGHTS=(
    "outputs/mrcnn_ps_exps/burn_in_030/01/burn_in_best_model.pth"
    #"outputs/mrcnn_ps_exps/burn_in_030/02/burn_in_best_model.pth"
    #"outputs/mrcnn_ps_exps/burn_in_030/02/burn_in_best_model.pth"
)
TEST_DATASET="('jersey_test',)"

OUTPUT_DIRS=(
    "outputs/mrcnn_ps_exps/burn_in_030/01"
    #"outputs/mrcnn_ps_exps/burn_in_030/02"
    #"outputs/mrcnn_ps_exps/burn_in_030/03"
)
